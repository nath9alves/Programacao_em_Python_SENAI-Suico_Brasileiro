# Exercício 1 - Variáveis (soma)

# @title Crie um programa para receber dois valores e em seguida exiba a soma deles
...
# Exercício 2 - Variáveis (diferença)

# @title Crie um programa que recebe dois valores e em seguida exiba a diferença deles
...
# Exercício 3 - Variáveis (divisão)

# @title Crie um programa que recebe dois valores e em seguida exibe o quociente deles
...
# Exercício 4 - Variáveis (multiplicação)

# @title Crie um programa que recebe dois valores e em seguida exibe o produto deles
...
# @title Crie um programa que recebe um valor do usuário e calcule o quadrado desse número. Em seguida, exibe o resultado.
...
# Exercício 6 - Biblioteca math

# @title Crie um programa que pede um número e calcula a raíz quadrada dele usando a biblioteca math.
